...
pub enum OpenGraphTag {
    ...
    SiteName,
    /// Represents the "og:profile:username" OpenGraph's meta tag
    ProfileUsername,
    /// Represents the "og:profile:gender" OpenGraph meta tag
    ProfileGender,
}
...
impl OpenGraphTag {
    fn str(&self) -> &str {
        match self {
            ...
            OpenGraphTag::ProfileUsername => "profile:username",
            OpenGraphTag::ProfileGender => "profile:gender",
        }
    }
}
...
mod tests {
    ...
    fn retrieves_description_from_og_compilant_html() {
        ...
        assert_eq!(description, "John Appleseed tells you his secrets on SEO for a better web experience by taking advantage of OpenGraphTag\'s Tags!");
    }
